...
// ==========================================
// MOTION GRAPHICS BACKGROUND CANVAS & SCROLL REVEAL
// ==========================================

window.addEventListener('DOMContentLoaded', () => {
    // Initialize Canvas Motion Graphics Background
    ...
    if (canvas) {
        ...
        function animateBackground() {
            ...
            for (let i = 0; i < particles.length; i++) {
                ...
                if (mouse.x !== null && mouse.y !== null) {
                    ...
                    if (dist < connectionDistance * 1.5) {
                        ...
                        ctx.strokeStyle = `rgba(0, 242, 254, ${0.15 * (1 - dist / (connectionDistance * 1.5))})`;
                        ctx.lineWidth = 0.8;
                        ctx.stroke();
                    }
                }
                ...
                for (let j = i + 1; j < particles.length; j++) {
                    ...
                    if (dist < connectionDistance) {
                        ...
                        ctx.strokeStyle = `rgba(79, 172, 254, ${0.12 * (1 - dist / connectionDistance)})`;
                        ctx.lineWidth = 0.6;
                        ctx.stroke();
                    }
                }
            ...
            for (let i = 0; i < particles.length; i++) {
                ...
                ctx.fillStyle = i % 2 === 0 ? 'rgba(0, 242, 254, 0.4)' : 'rgba(161, 140, 209, 0.35)';
                ctx.fill();
